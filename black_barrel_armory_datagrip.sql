...
-- -----------------------------------------------------
-- Schema black_barrel_armory
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `black_barrel_armory`;

-- -----------------------------------------------------
-- Schema black_barrel_armory
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `black_barrel_armory` DEFAULT CHARACTER SET utf8;
USE `black_barrel_armory`;

-- -----------------------------------------------------
-- Table `black_barrel_armory`.`countries`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `black_barrel_armory`.`countries`
(
...
-- -----------------------------------------------------
-- Table `black_barrel_armory`.`states`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `black_barrel_armory`.`states`
(
    ...
    CONSTRAINT `fk_states_countries`
        FOREIGN KEY (`country_id`)
            REFERENCES `black_barrel_armory`.`countries` (`id`)
            ON DELETE NO ACTION
            ON UPDATE CASCADE
);
...
-- -----------------------------------------------------
-- Table `black_barrel_armory`.`ffl_dealers`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `black_barrel_armory`.`ffl_dealers`
(
    ...
    CONSTRAINT `fk_ffl_dealers_states1`
        FOREIGN KEY (`state_id`)
            REFERENCES `black_barrel_armory`.`states` (`id`)
            ON DELETE RESTRICT
            ON UPDATE CASCADE
);
...
-- -----------------------------------------------------
-- Table `black_barrel_armory`.`customers`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `black_barrel_armory`.`customers`
(
    `id`                      INT          NOT NULL AUTO_INCREMENT COMMENT 'Unique identifier for the entry.',
    ...
    CONSTRAINT `fk_customers_ffl_dealers1`
        FOREIGN KEY (`preferred_ffl_dealer_id`)
            REFERENCES `black_barrel_armory`.`ffl_dealers` (`id`)
            ON DELETE RESTRICT
            ON UPDATE CASCADE
);
...
-- -----------------------------------------------------
-- Table `black_barrel_armory`.`addresses`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `black_barrel_armory`.`addresses`
(
    `id`            INT          NOT NULL AUTO_INCREMENT COMMENT 'Unique identifier for the entry.',
    ...
    CONSTRAINT `fk_addresses_customers1`
        FOREIGN KEY (`customer_id`)
            REFERENCES `black_barrel_armory`.`customers` (`id`)
            ON DELETE RESTRICT
            ON UPDATE CASCADE
);
...
-- -----------------------------------------------------
-- Table `black_barrel_armory`.`credit_card_types`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `black_barrel_armory`.`credit_card_types`
(
    `id`          INT          NOT NULL AUTO_INCREMENT COMMENT 'Unique identifier for each entry.',
    `name`        VARCHAR(255) NOT NULL COMMENT 'Full name of the credit card (e.g., \"Mastercard\").',
...
-- -----------------------------------------------------
-- Table `black_barrel_armory`.`credit_cards`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `black_barrel_armory`.`credit_cards`
(
    ...
    INDEX `fk_credit_cards_customers1_idx` (`customer_id` ASC),
    INDEX `fk_credit_cards_addresses1_idx` (`billing_address_id` ASC),
    INDEX `fk_credit_cards_credit_card_types1_idx` (`card_type_id` ASC),
    ...
    CONSTRAINT `fk_credit_cards_addresses1`
        FOREIGN KEY (`billing_address_id`)
            REFERENCES `black_barrel_armory`.`addresses` (`id`)
            ON DELETE RESTRICT
            ON UPDATE CASCADE,
    CONSTRAINT `fk_credit_cards_credit_card_types1`
        FOREIGN KEY (`card_type_id`)
            REFERENCES `black_barrel_armory`.`credit_card_types` (`id`)
            ON DELETE NO ACTION
            ON UPDATE NO ACTION
);
...
-- -----------------------------------------------------
-- Table `black_barrel_armory`.`product_categories`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `black_barrel_armory`.`product_categories`
(
...
-- -----------------------------------------------------
-- Table `black_barrel_armory`.`product_types`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `black_barrel_armory`.`product_types`
(
    ...
    CONSTRAINT `fk_product_types_product_categories1`
        FOREIGN KEY (`category_id`)
            REFERENCES `black_barrel_armory`.`product_categories` (`id`)
            ON DELETE RESTRICT
            ON UPDATE CASCADE
);
...
-- -----------------------------------------------------
-- Table `black_barrel_armory`.`products`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `black_barrel_armory`.`products`
(
    ...
    CONSTRAINT `fk_products_product_types1`
        FOREIGN KEY (`product_type_id`)
            REFERENCES `black_barrel_armory`.`product_types` (`id`)
            ON DELETE RESTRICT
            ON UPDATE CASCADE
);
...
-- -----------------------------------------------------
-- Table `black_barrel_armory`.`desired_products`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `black_barrel_armory`.`desired_products`
(
    ...
    CONSTRAINT `fk_desired_products_products1`
        FOREIGN KEY (`product_id`)
            REFERENCES `black_barrel_armory`.`products` (`id`)
            ON DELETE RESTRICT
            ON UPDATE CASCADE,
...
-- -----------------------------------------------------
-- Table `black_barrel_armory`.`saved_for_later_products`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `black_barrel_armory`.`saved_for_later_products`
(
    `id`          INT       NOT NULL AUTO_INCREMENT COMMENT 'Unique identifier for the entry.',
...
-- -----------------------------------------------------
-- Table `black_barrel_armory`.`cart_items`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `black_barrel_armory`.`cart_items`
(
    `id`          INT       NOT NULL AUTO_INCREMENT COMMENT 'Unique identifier for the entry.',
    `product_id`  INT       NOT NULL COMMENT 'Links to the products table. Foreign key referencing products.id',
    `customer_id` INT       NOT NULL COMMENT 'Links to the customers table. Foreign key referencing customers.id',
...
-- -----------------------------------------------------
-- Table `black_barrel_armory`.`orders`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `black_barrel_armory`.`orders`
(
    `id`                           INT                                          NOT NULL AUTO_INCREMENT COMMENT 'Unique identifier for the entry.',
...
-- -----------------------------------------------------
-- Table `black_barrel_armory`.`order_items`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `black_barrel_armory`.`order_items`
(
    `id`                  INT            NOT NULL AUTO_INCREMENT COMMENT 'Unique identifier for the entry.',
    ...
    CONSTRAINT `fk_order_items_orders1`
        FOREIGN KEY (`order_id`)
            REFERENCES `black_barrel_armory`.`orders` (`id`)
            ON DELETE RESTRICT
            ON UPDATE CASCADE
);
...
-- -----------------------------------------------------
-- Table `black_barrel_armory`.`product_images`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `black_barrel_armory`.`product_images`
(
    `id`            INT          NOT NULL AUTO_INCREMENT COMMENT 'Unique identifier for the entry.',
    `product_id`    INT          NOT NULL COMMENT 'Foreign key referencing products.id',
    `s3_url`        VARCHAR(255) NOT NULL COMMENT 'URL of the image at Amazon S3 (e.g., https://example.com/images/product1.jpg).',
    `description`   TEXT         NULL COMMENT 'Optional description or alternative text for the image.',
